...
*/
    ...
    //printf("JJJJJJJJJJJJJJJ ******* "); fflush(stdout);
    if (found)
    {
        for (k=mm;k>=0;k--)
        ...
        { /* store details in E, x and y for later */
            b[k]=jj;
            //printf("sss %d ****************************", jj); fflush(stdout);
            copy(XX,x[jj]);
            //printf("xqqq *****************************"); fflush(stdout);
            //printf("%d", jj);
            //printf("%p %p %d\m", YY, y[jj], jj);
            //cotnum(YY, stdout);
            cotnum(y[jj], stdout);
            //scanf("%*d");
            copy(YY,y[jj]);
...
*/
    //printf("XXXXXXXXXXXX ********** "); fflush(stdout);
...
{ /* factoring via quadratic sieve */
    ...
    */  
    ...
    { /* try a new polynomial */
        ...
        cotnum(AA, stdout); printf("\n"); fflush(stdout);
        cotnum(BB, stdout); printf("\n"); fflush(stdout);
        //cotnum(DG, stdout); printf("\n"); fflush(stdout);
        //cotnum(DD, stdout); printf("\n"); fflush(stdout);
        cotnum(TT, stdout); printf("\n"); fflush(stdout);
        cotnum(IG, stdout); printf("\n"); fflush(stdout);
